...
single_variant_file <- if(exists("params")) params$single_variant_file else "step2_single_variant_STATUS.regenie"
...
if(nrow(significant_variants) > 0) {
    kable(significant_variants[1:min(10, nrow(significant_variants)),], 
...
if(nrow(significant_genes) > 0) {
    kable(significant_genes[1:min(15, nrow(significant_genes)),], 
          format = "html", digits = 4,
